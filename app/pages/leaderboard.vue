...
<template>
  ...
  <div class="relative z-10 flex flex-col gap-10 max-w-4xl mx-auto">
    <header class="text-center flex flex-col gap-4">
      <div class="inline-flex items-center justify-center p-6 bg-indigo-100 rounded-[2.5rem] shadow-inner self-center">
    ...
    <div class="flex flex-col md:flex-row items-end justify-center gap-6 mt-10 mb-6">
      ...
      <div class="flex flex-col items-center gap-4 order-2 md:order-1">
        ...
        <div class="bg-gray-100 p-8 rounded-t-3xl w-32 flex flex-col items-center shadow-lg border-2 border-white">
      ...
      <div class="flex flex-col items-center gap-4 order-3">
        ...
        <div class="bg-orange-100 p-6 rounded-t-2xl w-28 flex flex-col items-center shadow-md border-2 border-white">
